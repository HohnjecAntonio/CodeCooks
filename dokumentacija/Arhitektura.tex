...
\begin{longtblr}[
	...
	\SetCell{LightBlue}IDObjava    & INT     & jedinstveni identifikator objave    \\ \hline
...
\begin{longtblr}[
	...
	\SetCell{LightBlue}IDOznaka       & INT     & ID oznake recepta                    \\ \hline
	SlikaRecept                       & VARCHAR & Slika recepta                        \\ \hline
	\SetCell{LightBlue}IDVideoRecept  & INT     & ID Video recepta                     \\ \hline
\end{longtblr}
